...
typedef struct CANCom
{
	...
	//Uint16 (*SendDataWithPtc)(Uint16 FunCode,float data,MailBoxType mbType);
	Uint16 (*SendDataWithPtc)(Uint16 FunCode,float data1,float data2,float data3,float data4,float data5,Uint16 data6,MailBoxType mbType) ;     //使用协议发送浮点数
	Uint16 (*SendDataWithPtc2)(Uint16 FunCode,MailBoxType mbType) ;
